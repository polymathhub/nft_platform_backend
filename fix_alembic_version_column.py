#!/usr/bin/env python3
"""
Fix the alembic_version column size issue.

This script will:
1. Check the current state of alembic_version table
2. Manually fix the column if needed
3. Allow migrations to proceed
"""
import os
import asyncio
...
async def fix_alembic_version():
    """Fix the alembic_version table column size."""
